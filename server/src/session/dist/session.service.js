...
var SessionService = /** @class */ (function () {
    function SessionService(sessionModel, userModel) {
    ...
    SessionService.prototype.updateSession = function (id, decisions) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        results = [];
                        for (i = 0; i < session.user_1_decisions.length; ++i) {
    ...
    SessionService = __decorate([
        common_1.Injectable(),
        __param(0, common_1.Inject('Session_MODEL')),
        __param(1, common_1.Inject('User_MODEL'))
    ], SessionService);

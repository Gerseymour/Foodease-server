...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.signUp = function (createUserDto) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.signUp(createUserDto)];
            });
        });
    };
    ...
    UserController.prototype.logIn = function (username) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.logIn(username)];
            });
        });
    };
    __decorate([
